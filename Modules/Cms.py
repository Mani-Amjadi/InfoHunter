...
########################
    sleep(0.2)
    print (Fore.LIGHTGREEN_EX + " \n  [" + Fore.LIGHTWHITE_EX + "!" + Fore.LIGHTGREEN_EX + "]" + Fore.LIGHTCYAN_EX + " Wellcome To Cms Part")
    sleep(0.2)
...
########################
        Domain = "http://" + Domain
        Info = builtwith.parse(Domain)
##########################
        for Key in Info:
            Value = " "
            for Val in Info[str(Key)]:
                Key = Key.replace('-'," ")
                Key = Key.title()
                Value += str(Val) +Fore.RED+ " - "+Fore.LIGHTGREEN_EX
                sleep(0.2)
            print (Fore.LIGHTGREEN_EX + "  [" + Fore.LIGHTWHITE_EX + "+" + Fore.LIGHTGREEN_EX + "] " + Fore.LIGHTCYAN_EX + Key + Fore.RED + " : " + Fore.LIGHTGREEN_EX + Value + "\n")
##########################
