...
########################
    sleep(0.2)
    print (Fore.LIGHTGREEN_EX + " \n  [" + Fore.LIGHTWHITE_EX + "!" + Fore.LIGHTGREEN_EX + "]" + Fore.LIGHTCYAN_EX + " Wellcome to Find Shared Dns Part")
    sleep(0.2)
...
########################
            ...
            return
########################
        Result = get("http://api.hackertarget.com/findshareddns/?q=" + Domain).text
