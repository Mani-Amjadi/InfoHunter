...
def __Start__():
########################
    SomeUrl = ['admin/','administrator/','login.php/','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
########################
    sleep(0.2)
    print (Fore.LIGHTGREEN_EX + "\n  [" + Fore.LIGHTWHITE_EX + "!" + Fore.LIGHTGREEN_EX + "]" + Fore.LIGHTCYAN_EX + " Wellcome To Admin Page Finder Part")
    sleep(0.2)
        ...
        for Url in SomeUrl :
            try :
                ...
                if Site.status_code == 200 :
                    print (Fore.LIGHTGREEN_EX + "\n  [" + Fore.LIGHTWHITE_EX + "+" + Fore.LIGHTGREEN_EX + "] " + Fore.LIGHTCYAN_EX + "Admin Page " + Fore.RED + " | " + Fore.LIGHTGREEN_EX + Domain+Url + Fore.RED + " | " + Fore.LIGHTCYAN_EX + "Found")
                else :
                    print (Fore.LIGHTGREEN_EX + "\n  [" + Fore.LIGHTWHITE_EX + "-" + Fore.LIGHTGREEN_EX + "] " + Fore.LIGHTCYAN_EX + "Admin Page " + Fore.RED + " | " + Fore.LIGHTGREEN_EX + Domain+Url + Fore.RED + " | " + Fore.LIGHTCYAN_EX + "Not Found")
            except :
                sleep(0.2)
